...
class EmployeeDialogs:
    """Class chứa các dialog xác nhận và cảnh báo cho nhân viên."""
    ...
    def show_confirm_delete_popup(self, employee_name, on_confirm_callback):
        ...
        # Nội dung popup
        message = f"Bạn có chắc muốn xóa nhân viên\n'{employee_name}' không?"
        label = ctk.CTkLabel(
            popup,
            text=message,
