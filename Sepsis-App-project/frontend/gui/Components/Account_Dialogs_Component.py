...
class AccountDialogs:
    """Class chứa các dialog xác nhận và cảnh báo cho tài khoản."""
    ...
    def show_confirm_delete_popup(self, account_name, on_confirm_callback):
        ...
        # Nội dung popup
        message = f"Bạn có chắc muốn xóa tài khoản\n'{account_name}' không?"
        label = ctk.CTkLabel(
            popup,
            text=message,
