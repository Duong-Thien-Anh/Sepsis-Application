...
INSERT INTO Employee (code, full_name, date_of_birth, gender, address, position, department, start_date, salary, education_level, license_number, emergency_contact_name, emergency_contact_relation, emergency_contact_phone, photo_path, account_id) VALUES
