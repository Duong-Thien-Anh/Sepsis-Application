...
auth_bp.route('/forgot-password', methods=['POST'])(auth_controller.forgot_password_controller)
auth_bp.route('/reset-password', methods=['POST'])(auth_controller.reset_password_controller)